  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: 'googlecb346f17d96186ee.html', to: 'googlecb346f17d96186ee.html' },
        { from: 'about.html', to: 'about.html' },
        { from: 'contact.html', to: 'contact.html' },
        { from: 'mirror.html', to: 'mirror.html' },
        { from: 'fps-checker.html', to: 'fps-checker.html' },
        { from: 'resolution-tester.html', to: 'resolution-tester.html' },
        { from: 'take-photo.html', to: 'take-photo.html' },
        { from: 'show-webcam.html', to: 'show-webcam.html' },
